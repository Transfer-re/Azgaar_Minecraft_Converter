 ...
 *
 * <p>This class provides a registration method, utilizing packet objects, {@link #registerGlobalReceiver(class_8710.class_9154, PlayPayloadHandler)}.
 ...
 *
 * <ul>
 *     <li>A class implementing {@link class_8710} that is "sent" over the network</li>
 *     <li>{@link class_8710.class_9155} instance, which represents the packet's type (and its codec)</li>
...
public final class ServerPlayNetworking {
	 ...
	 * Use {@link #unregisterGlobalReceiver(class_2960)} to unregister the existing handler.
	 *
	 ...
	 * or it was not registered using {@link #registerGlobalReceiver(class_8710.class_9154, PlayPayloadHandler)}
	 * @see ServerPlayNetworking#registerGlobalReceiver(class_8710.class_9154, PlayPayloadHandler)
	 * @see ServerPlayNetworking#unregisterReceiver(class_3244, class_2960)
	 */
	@Nullable
	public static ServerPlayNetworking.PlayPayloadHandler<?> unregisterGlobalReceiver(class_2960 id) {
	...
	/**
	 * Registers a handler for a payload type.
	 * This method differs from {@link ServerPlayNetworking#registerGlobalReceiver(class_8710.class_9154, PlayPayloadHandler)} since
	 ...
	 * @return the previous handler, or {@code null} if no handler was bound to the channel,
	 * or it was not registered using {@link #registerReceiver(class_3244, class_8710.class_9154, PlayPayloadHandler)}
	 */
	@Nullable
	public static ServerPlayNetworking.PlayPayloadHandler<?> unregisterReceiver(class_3244 networkHandler, class_2960 id) {
	...
	public static boolean canSend(class_3222 player, class_8710.class_9154<?> type) {
		...
		return canSend(player.field_13987, type.comp_2242());
	}
	...
	public static void send(class_3222 player, class_8710 payload) {
		...
		Objects.requireNonNull(payload.method_56479(), "CustomPayload#getId() cannot return null for payload class: " + payload.getClass());

		player.field_13987.method_14364(createS2CPacket(payload));
	}
	...
	public static void reconfigure(class_3222 player) {
		...
		reconfigure(player.field_13987);
	}
	...
	/**
	 * A thread-safe packet handler utilizing {@link class_8710}.
	...
	public interface PlayPayloadHandler<T extends class_8710> {
		 ...
		 * }</pre>
		 *
		 * <p>The network handler can be accessed via {@link class_3222#field_13987}.
		 *
